    ...
    >
      ...
      <div className="p-1.5 border-r lg:border-r-0 lg:border-b-2 border-black/10 bg-parchment/50 space-y-1 w-64 lg:w-full flex-shrink-0">
        ...
        <div className="grid grid-cols-2 gap-1.5">
          <div className="flex flex-col p-1.5 neo-brutalist-card-sm">
                  ...
                  <div className="space-y-1.5">
                    ...
                    {occupant && (
                      <div className="space-y-1">
                        <div className="p-1.5 neo-brutalist-card-sm border-black/20">
                    ...
                    {/* Tile Info */}
                    <div className="space-y-1">
                      <div className="p-1.5 neo-brutalist-card-parchment">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex-1">
                            <p className="font-black text-base tracking-tight leading-none mb-1">{tile.terrain}</p>
                    ...
                    {unit && (
                      <div className="space-y-1">
                        <div className="p-1.5 neo-brutalist-card-parchment border-black/10">
                          <div className="flex items-center gap-3 mb-1.5">
                            ...
                            <div>
                              <p className="font-black text-base tracking-tight leading-none mb-1">{unit.type}</p>
                          ...
                          <div className="grid grid-cols-2 gap-1.5">
                            <div className="p-1.5 bg-white border border-black/10 rounded-xl">
                              <p className="text-sm font-black opacity-40 mb-0.5">Movement</p>
                              <div className="flex items-center gap-1">
                            ...
                            <div className="p-1.5 bg-white border border-black/10 rounded-xl">
                              <p className="text-sm font-black opacity-40 mb-0.5">Range</p>
                              <div className="flex items-center gap-1">
                          ...
                          {(Object.keys(UNIT_STATS) as UnitType[]).map(type => {
                            ...
                            return (
                              <GameButton
                                ...
                                variant="parchment"
                                fullWidth
                                className="p-1.5 border-2 border-black flex items-center justify-between transition-all relative group rounded-xl"
                              >
                                <div className="flex items-center gap-2">
                                  <span className="text-xl">{UNIT_ICONS[type]}</span>
                                  <div className="text-left">
                                    <p className="font-black text-sm leading-none mb-0.5">{type}</p>
                        ...
                        {(() => {
                          ...
                          return (
                            <GameButton
                              ...
                              fullWidth
                              className={cn(
                                "p-1.5 border-2 border-black flex items-center justify-between transition-all rounded-xl",
      ...
      {!gameState.isPlaybackMode && (
        <div className="p-1.5 border-l lg:border-l-0 lg:border-t-2 border-black/10 bg-parchment/50 space-y-1 w-48 lg:w-full flex-shrink-0">
